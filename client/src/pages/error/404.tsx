            ...
            <section classes={["content"]}>
                <div classes={["error-page"]}>
                    ...
                    <div classes={["error-content", c.text_center, c.ml_0]}>
                        <h3><FontAwesomeIcon icon="exclamation-triangle" classes={[c.text_warning]} /> 你访问的页面不存在。</h3>
                        <div classes={[c.mt_5]}><Link classes={[c.btn, c.btn_primary]} to="home">返回首页</Link></div>
                    </div>
                </div>
            </section>
        </virtual>
